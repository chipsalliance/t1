...
class LaneShifterOM(parameter: LaneShifterParameter) extends GeneralOM[LaneShifterParameter, LaneShifterVFU](parameter) {
...
@instantiable
class LaneShifterVFU(val parameter: LaneShifterParameter) extends VFUModule with SerializableModule[LaneShifterParameter] {
