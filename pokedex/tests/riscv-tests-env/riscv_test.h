...
// Pass/Fail Macro
//-----------------------------------------------------------------------
// We want to share one binary for our simulator and Spike, and thus the
// tests code needs to exit both of them. Our simulator supports exit with
// various exit code from MMIO, however Spike can only exits succesfully
// with 1, so we need to override the argument here.
