...
in
{
  ...
  "com.lihaoyi_mainargs_3-0.5.0" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_3/0.5.0/mainargs_3-0.5.0.pom" ];
    hash = "sha256-DFvn7IzklnC1DHMAuzJe62FnqG498iZXMgpGswwUW0Y=";
  ...
  "com.lihaoyi_os-lib_3-0.9.1" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/os-lib_3/0.9.1/os-lib_3-0.9.1.pom" ];
    hash = "sha256-e26wc6cwE0sy7hV9Cf8/EyC85O+xYPxIBKQglDIc3M0=";
  ...
  "com.lihaoyi_ujson_3-3.3.1" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/ujson_3/3.3.1/ujson_3-3.3.1.pom" ];
    hash = "sha256-TMoT34HUrdVEH1OClqhNKpULmCmE20zQpDH8oGVokck=";
  ...
  "com.lihaoyi_upack_3-3.3.1" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/upack_3/3.3.1/upack_3-3.3.1.pom" ];
    hash = "sha256-8lAp3dtQSxbHGw+sZOGFikWLMxvdi/Ct8JZ6L/7IS0Y=";
  ...
  "com.lihaoyi_upickle-core_3-3.3.1" = fetchMaven {
    ...
    hash = "sha256-PNczD/uZ+/64OQdC2sfRvstVdrr9s+0p9WlNreupxuE=";
  ...
  "com.lihaoyi_upickle-implicits_3-3.3.1" = fetchMaven {
    ...
    hash = "sha256-A18l95VeVCyNPKyVlr0GIGJ+if8omy4E/tZFg82rhWw=";
  ...
  "com.lihaoyi_upickle_3-3.3.1" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/upickle_3/3.3.1/upickle_3-3.3.1.pom" ];
    hash = "sha256-PTx8h7LHfxsr+rT+gbrgmrW62ex85CUqTHUpCu8aSKQ=";
  ...
  "org.scala-lang.modules_scala-collection-compat_3-2.8.1" = fetchMaven {
    ...
    hash = "sha256-RIHw8h3v7KFwmfqFZCzP/Y4KhnMlNshZFekwlgpVRPc=";
...
# Project Source Hash:sha256-dcYI1jh7XEzrNv+XqmdTgVVb1WW7p/WL+rw1EHWbRyY=
