...
in
{
  ...
  "com.lihaoyi_geny_2.13-1.0.0" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/geny_2.13/1.0.0/geny_2.13-1.0.0.pom" ];
  ...
  "com.lihaoyi_mainargs_2.13-0.5.0" = fetchMaven {
    ...
    urls = [
      "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.5.0/mainargs_2.13-0.5.0.jar"
      "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.5.0/mainargs_2.13-0.5.0.pom"
    ];
    hash = "sha256-rDT0ViOnVDZHbqzjcW0vevSpdKzNjrBOAc9XPj5C3+s=";
  ...
  "com.lihaoyi_os-lib_2.13-0.9.1" = fetchMaven {
    name = "com.lihaoyi_os-lib_2.13-0.9.1";
    urls = [
      "https://repo1.maven.org/maven2/com/lihaoyi/os-lib_2.13/0.9.1/os-lib_2.13-0.9.1.jar"
      "https://repo1.maven.org/maven2/com/lihaoyi/os-lib_2.13/0.9.1/os-lib_2.13-0.9.1.pom"
    ];
    hash = "sha256-6vif76Fw/bDtFqNnehOBiULNCEbpQ79WjXDLOxtlsuM=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/os-lib_2.13/0.9.1";
  };
...
# Project Source Hash:sha256-FKnHsFTr1cD8+WpdU+uQWsH/8Iic6YSgp+mcVzZugFs=
