...
5.Build Instruction <span style="display: inline-block;"></span> ⁠1

5.1.Debug generated code <span style="display: inline-block;"></span> ⁠1

5.2.Get archived ASL library
<span style="display: inline-block;"></span> ⁠1

6.Appendix A: <span style="display: inline-block;">`ASLi`</span>
commands for lowering <span style="display: inline-block;"></span> ⁠1

6.1.Filter unreachable code from exports
<span style="display: inline-block;"></span> ⁠1

6.2.Eliminate <span style="display: inline-block;">`typedef`</span>
<span style="display: inline-block;"></span> ⁠1
...
6.7.Convert getter/setter <span style="display: inline-block;"></span> ⁠1

6.8.TODO <span style="display: inline-block;"></span> ⁠1

6.9.Constant propagation <span style="display: inline-block;"></span> ⁠1

6.10.Monomorphicalize functions
<span style="display: inline-block;"></span> ⁠1

6.11.Lift let-expressions <span style="display: inline-block;"></span> ⁠1

6.12.Convert bit vector slice operation to bit operation
<span style="display: inline-block;"></span> ⁠1

6.13.Convert match to if <span style="display: inline-block;"></span> ⁠1

6.14.Wrap variable <span style="display: inline-block;"></span> ⁠1

6.15.Create bounded int <span style="display: inline-block;"></span> ⁠1

6.16.Filter function not listed in imports
<span style="display: inline-block;"></span> ⁠1

6.17.Check monomorphic <span style="display: inline-block;"></span> ⁠1
...
The <span style="display: inline-block;">`step`</span> function at ASL
model will try reset architecture states when the
<span style="display: inline-block;">`FFI_is_reset`</span> function
return true. The return value is maintained by the
<span style="display: inline-block;">`is_reset`</span> field in
<span style="display: inline-block;">`Simulator`</span>. It can only be
accessed by a getter function shown as follow, which will update the
state after read.
...
## 6. Appendix A: <span style="display: inline-block;">`ASLi`</span> commands for lowering
