...
This section contains basic information of how to implement CSRs to
models.

#### Reading and Writing CSRs

All Control and Status Register (CSR) operations are handled by two main
APIs that are generated by the codegen-cli tool.
...
`codegen-cli` tool looks for these files in two directories:
