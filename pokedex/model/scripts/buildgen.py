...
class CustomWriter(ninja_syntax.Writer):
    ...
    def var_env(w, env_name: str):
        w.variable(env_name, os.environ[env_name])
...
if __name__ == "__main__":
    ...
    no_check = ("BUILDGEN_NO_CHECK" in os.environ) and (os.environ["BUILDGEN_NO_CHECK"] == "1")
    ...
    outstr = io.StringIO()
    w = CustomWriter(outstr, args.config, dry_run=args.dry_run)
    w.generate()
