...
begin
  ...
  let most_significant_half : FFI_ReadResult(16) = FFI_instruction_fetch_half(PC);
  ...
  if most_significant_half.data[1:0] == '11' then
    let least_significant_half : FFI_ReadResult(16) = FFI_instruction_fetch_half(PC + 2);
    ...
    exec_result = DecodeAndExecute_CEXT(most_significant_half.data);
  end
