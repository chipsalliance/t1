...
import chisel3._
import chisel3.util.{isPow2, log2Ceil, log2Up, Cat, Decoupled, Mux1H, OHToUInt, PopCount, RegEnable, Valid}
...
class ICacheErrors(implicit p: Parameters) extends CoreBundle()(p) with HasL1ICacheParameters with CanHaveErrors {
