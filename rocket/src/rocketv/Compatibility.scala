...
object Causes {
  val decoderdb = causes(extractResource(getClass.getClassLoader)).toMap
  val misaligned_fetch = decoderdb("misaligned_fetch")
  val fetch_access = decoderdb("fetch_access")
  val illegal_instruction = decoderdb("illegal_instruction")
  val breakpoint = decoderdb("breakpoint")
  val misaligned_load = decoderdb("misaligned_load")
  val load_access = decoderdb("load_access")
  val misaligned_store = decoderdb("misaligned_store")
  val store_access = decoderdb("store_access")
  val user_ecall = decoderdb("user_ecall")
  val supervisor_ecall = decoderdb("supervisor_ecall")
  val virtual_supervisor_ecall = decoderdb("virtual_supervisor_ecall")
  val machine_ecall = decoderdb("machine_ecall")
  val fetch_page_fault = decoderdb("fetch_page_fault")
  val load_page_fault = decoderdb("load_page_fault")
  val store_page_fault = decoderdb("store_page_fault")
  val fetch_guest_page_fault = decoderdb("fetch_guest_page_fault")
  val load_guest_page_fault = decoderdb("load_guest_page_fault")
  val virtual_instruction = decoderdb("virtual_instruction")
  val store_guest_page_fault = decoderdb("store_guest_page_fault")
  val all = {
...
object CSRs {
  val csrs = org.chipsalliance.rvdecoderdb.csrs(extractResource(getClass.getClassLoader))
  val csrs32 = org.chipsalliance.rvdecoderdb.csrs(extractResource(getClass.getClassLoader))
...
// TODO: remove me with chisel decoder.
object DecodeLogic
{
  import chisel3._
