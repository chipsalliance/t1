...
object rvdecoderdbcompat {
  ...
  object Causes {
    ...
    val user_ecall = causes("user_ecall")
    val supervisor_ecall = causes("supervisor_ecall")
    val virtual_supervisor_ecall = causes("virtual_supervisor_ecall")
    val machine_ecall = causes("machine_ecall")
