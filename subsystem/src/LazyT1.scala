...
class LazyT1Imp(outer: LazyT1)(implicit p: Parameters) extends AbstractLazyT1ModuleImp(outer) {
  ...
  outer.t1LSUNodes.head.out.zipWithIndex.foreach {
    case ((bundle, _), i) =>
      bundle.a.bits.opcode := t1.memoryPorts.head(i).a.bits.opcode
      bundle.a.bits.param := t1.memoryPorts.head(i).a.bits.param
      bundle.a.bits.size := t1.memoryPorts.head(i).a.bits.size
      bundle.a.bits.source := t1.memoryPorts.head(i).a.bits.source
      bundle.a.bits.address := t1.memoryPorts.head(i).a.bits.address
      bundle.a.bits.mask := t1.memoryPorts.head(i).a.bits.mask
      bundle.a.bits.data := t1.memoryPorts.head(i).a.bits.data
      bundle.a.bits.corrupt := t1.memoryPorts.head(i).a.bits.corrupt
      bundle.a.valid := t1.memoryPorts.head(i).a.valid
      t1.memoryPorts.head(i).a.ready := bundle.a.ready
      t1.memoryPorts.head(i).d.bits.opcode := bundle.d.bits.opcode
      t1.memoryPorts.head(i).d.bits.param := bundle.d.bits.param
      t1.memoryPorts.head(i).d.bits.size := bundle.d.bits.size
      t1.memoryPorts.head(i).d.bits.source := bundle.d.bits.source
      t1.memoryPorts.head(i).d.bits.sink := bundle.d.bits.sink
      t1.memoryPorts.head(i).d.bits.denied := bundle.d.bits.denied
      t1.memoryPorts.head(i).d.bits.data := bundle.d.bits.data
      t1.memoryPorts.head(i).d.bits.corrupt := bundle.d.bits.corrupt
      t1.memoryPorts.head(i).d.valid := bundle.d.valid
      bundle.d.ready := t1.memoryPorts.head(i).d.ready
