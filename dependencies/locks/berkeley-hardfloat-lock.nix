{ fetchurl }: {
  ...
  "org.scalatest_scalatest-mustmatchers_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-mustmatchers_2.13-3.2.0";
    hash = "sha256-jO6hYpqnLh10t2ax9iZEKn4cE0ag+PQaSaZPlGTuK+U=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-mustmatchers_2.13/3.2.0/scalatest-mustmatchers_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-mustmatchers_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-mustmatchers_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-mustmatchers_2.13/3.2.0/scalatest-mustmatchers_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-mustmatchers_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-mustmatchers_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest-diagrams_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-diagrams_2.13-3.2.0";
    hash = "sha256-2gFSWYqLPGepE2d7qbZwqLRecIvNYDeaSTeV0ErHcrY=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-diagrams_2.13/3.2.0/scalatest-diagrams_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-diagrams_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-diagrams_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-diagrams_2.13/3.2.0/scalatest-diagrams_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-diagrams_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-diagrams_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest-freespec_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-freespec_2.13-3.2.0";
    hash = "sha256-grGoOx7sgOne14gdG56A3XMyKyEhTMHyrmIGIybmqoQ=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-freespec_2.13/3.2.0/scalatest-freespec_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-freespec_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-freespec_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-freespec_2.13/3.2.0/scalatest-freespec_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-freespec_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-freespec_2.13/3.2.0";
  };

  "org.scalatest_scalatest-featurespec_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-featurespec_2.13-3.2.0";
    hash = "sha256-lBlO4J22JZXJyTRbtx8Hm2KXYocQmRJU+jj+1xIFx+s=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-featurespec_2.13/3.2.0/scalatest-featurespec_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-featurespec_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-featurespec_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-featurespec_2.13/3.2.0/scalatest-featurespec_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-featurespec_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-featurespec_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest-flatspec_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-flatspec_2.13-3.2.0";
    hash = "sha256-Lrb2Ds136drqCGIkqcyJMOgVf45U4y7ucDFMHxZEpJI=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-flatspec_2.13/3.2.0/scalatest-flatspec_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-flatspec_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-flatspec_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-flatspec_2.13/3.2.0/scalatest-flatspec_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-flatspec_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-flatspec_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest-matchers-core_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-matchers-core_2.13-3.2.0";
    hash = "sha256-cR2XcUl2d5RVnP83way3ziK0FohYfyQ7CfQAPzk1MIQ=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-matchers-core_2.13/3.2.0/scalatest-matchers-core_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-matchers-core_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-matchers-core_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-matchers-core_2.13/3.2.0/scalatest-matchers-core_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-matchers-core_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-matchers-core_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest-refspec_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-refspec_2.13-3.2.0";
    hash = "sha256-biWikTaLMx3/5QKZQEaxzZocErWdUasdRnSgdZYVGuk=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-refspec_2.13/3.2.0/scalatest-refspec_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-refspec_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-refspec_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-refspec_2.13/3.2.0/scalatest-refspec_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-refspec_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-refspec_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest-compatible-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-compatible-3.2.0";
    hash = "sha256-dWKc1Qh8EtXfUGBTtVpgMazLy3BnQSvnx+o6JySgUtA=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-compatible/3.2.0/scalatest-compatible-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-compatible-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-compatible-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-compatible/3.2.0/scalatest-compatible-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-compatible-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-compatible/3.2.0";
  };
  ...
  "org.scalatest_scalatest-funspec_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-funspec_2.13-3.2.0";
    hash = "sha256-P1UIO5678JRxFcB3Z5Wm7pKSxUlhZYkGe+0Werbzy3o=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-funspec_2.13/3.2.0/scalatest-funspec_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-funspec_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-funspec_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-funspec_2.13/3.2.0/scalatest-funspec_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-funspec_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-funspec_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest-propspec_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-propspec_2.13-3.2.0";
    hash = "sha256-msaV11EUXYF589Tk9zVJsBHB2y5qOQ6sGIgdNjmEdpA=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-propspec_2.13/3.2.0/scalatest-propspec_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-propspec_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-propspec_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-propspec_2.13/3.2.0/scalatest-propspec_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-propspec_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-propspec_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest-core_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-core_2.13-3.2.0";
    hash = "sha256-dt43aGC7zOyc0+yamI1l/OhDqd5x7DDto71NIrNsYWE=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-core_2.13/3.2.0/scalatest-core_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-core_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-core_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-core_2.13/3.2.0/scalatest-core_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-core_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-core_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest-shouldmatchers_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-shouldmatchers_2.13-3.2.0";
    hash = "sha256-yR5SHVri+lMgicKGaA40p5o00X8wQUPvQv2GKy2k5WQ=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-shouldmatchers_2.13/3.2.0/scalatest-shouldmatchers_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-shouldmatchers_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-shouldmatchers_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-shouldmatchers_2.13/3.2.0/scalatest-shouldmatchers_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-shouldmatchers_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-shouldmatchers_2.13/3.2.0";
  };
  ...
  "org.scalactic_scalactic_2.13-3.2.0" = fetchurl {
    name = "org.scalactic_scalactic_2.13-3.2.0";
    hash = "sha256-qEsLS01efODwQukybeskgLNs4Jcil5PZiMOf/0nMYk0=";
    url = "https://repo1.maven.org/maven2/org/scalactic/scalactic_2.13/3.2.0/scalactic_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalactic_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalactic_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalactic/scalactic_2.13/3.2.0/scalactic_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalactic_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalactic/scalactic_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest-funsuite_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-funsuite_2.13-3.2.0";
    hash = "sha256-T2g7N14pOd8bIOsXqtoi4KUArsUDrfGq7XKMrtnJ3Dc=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-funsuite_2.13/3.2.0/scalatest-funsuite_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-funsuite_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-funsuite_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-funsuite_2.13/3.2.0/scalatest-funsuite_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-funsuite_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-funsuite_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest_2.13-3.2.0";
    hash = "sha256-3jKderktWXoLKAEtm6vv4xEOjfVFn9pgJ/ohkc3mblQ=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest_2.13/3.2.0/scalatest_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest_2.13/3.2.0/scalatest_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest_2.13/3.2.0";
  };
  ...
  "org.scalatest_scalatest-wordspec_2.13-3.2.0" = fetchurl {
    name = "org.scalatest_scalatest-wordspec_2.13-3.2.0";
    hash = "sha256-QTCpbV60gHMapVaS+OrbMmighavoit2pPdN/5PzGO7U=";
    url = "https://repo1.maven.org/maven2/org/scalatest/scalatest-wordspec_2.13/3.2.0/scalatest-wordspec_2.13-3.2.0.pom";
    recursiveHash = true;
    downloadToTemp = true;
    postFetch = ''
      mkdir -p "$out"
      cp -v "$downloadedFile" "$out/scalatest-wordspec_2.13-3.2.0.pom"
            
      downloadedFile=$TMPDIR/scalatest-wordspec_2.13-3.2.0.jar
      tryDownload "https://repo1.maven.org/maven2/org/scalatest/scalatest-wordspec_2.13/3.2.0/scalatest-wordspec_2.13-3.2.0.jar"
      cp -v "$TMPDIR/scalatest-wordspec_2.13-3.2.0.jar" "$out/"

    '';
    passthru.installPath = "https/repo1.maven.org/maven2/org/scalatest/scalatest-wordspec_2.13/3.2.0";
  };
