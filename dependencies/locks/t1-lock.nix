...
in
{
  ...
  "com.lihaoyi_mainargs_2.13-0.5.0" = fetchMaven {
    name = "com.lihaoyi_mainargs_2.13-0.5.0";
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.5.0/mainargs_2.13-0.5.0.pom" ];
    hash = "sha256-P3cYiWvt2oPKGxw5B0etnETDP3dU2QD/3ExJHeWh6ds=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.5.0";
  };

  "com.lihaoyi_mainargs_2.13-0.7.0" = fetchMaven {
    name = "com.lihaoyi_mainargs_2.13-0.7.0";
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.7.0/mainargs_2.13-0.7.0.jar" "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.7.0/mainargs_2.13-0.7.0.pom" ];
    hash = "sha256-JLN3zk3VYI8RkiLMqnB1RGGW+xyvQyEdUMpY+RPtY3s=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.7.0";
  };
  ...
  "com.lihaoyi_os-lib_3-0.9.1" = fetchMaven {
    name = "com.lihaoyi_os-lib_3-0.9.1";
    urls = [ "https://repo1.maven.org/maven2/com/lihaoyi/os-lib_3/0.9.1/os-lib_3-0.9.1.jar" "https://repo1.maven.org/maven2/com/lihaoyi/os-lib_3/0.9.1/os-lib_3-0.9.1.pom" ];
    hash = "sha256-VUeatMyLUWgVaHLi73VjsAbB1unRk5t3ebUcPEdL3Os=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/os-lib_3/0.9.1";
  };
  ...
  "org.typelevel_algebra_2.13-2.8.0" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/org/typelevel/algebra_2.13/2.8.0/algebra_2.13-2.8.0.jar" "https://repo1.maven.org/maven2/org/typelevel/algebra_2.13/2.8.0/algebra_2.13-2.8.0.pom" ];
  ...
  "org.typelevel_spire-macros_2.13-0.18.0" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/org/typelevel/spire-macros_2.13/0.18.0/spire-macros_2.13-0.18.0.jar" "https://repo1.maven.org/maven2/org/typelevel/spire-macros_2.13/0.18.0/spire-macros_2.13-0.18.0.pom" ];
  ...
  "org.typelevel_spire-platform_2.13-0.18.0" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/org/typelevel/spire-platform_2.13/0.18.0/spire-platform_2.13-0.18.0.jar" "https://repo1.maven.org/maven2/org/typelevel/spire-platform_2.13/0.18.0/spire-platform_2.13-0.18.0.pom" ];
  ...
  "org.typelevel_spire-util_2.13-0.18.0" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/org/typelevel/spire-util_2.13/0.18.0/spire-util_2.13-0.18.0.jar" "https://repo1.maven.org/maven2/org/typelevel/spire-util_2.13/0.18.0/spire-util_2.13-0.18.0.pom" ];
  ...
  "org.typelevel_spire_2.13-0.18.0" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/org/typelevel/spire_2.13/0.18.0/spire_2.13-0.18.0.jar" "https://repo1.maven.org/maven2/org/typelevel/spire_2.13/0.18.0/spire_2.13-0.18.0.pom" ];
  ...
  "org.scala-lang.modules_scala-collection-compat_2.13-2.11.0" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/org/scala-lang/modules/scala-collection-compat_2.13/2.11.0/scala-collection-compat_2.13-2.11.0.pom" ];
  ...
  "org.scala-lang.modules_scala-collection-compat_2.13-2.8.1" = fetchMaven {
    ...
    urls = [ "https://repo1.maven.org/maven2/org/scala-lang/modules/scala-collection-compat_2.13/2.8.1/scala-collection-compat_2.13-2.8.1.pom" ];
...
# Project Source Hash:sha256-hr8d7QB7lrWReVXwrN+z2SKrnxJhI68sW05sBHr8kEk=
