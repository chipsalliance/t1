{ fetchurl }: {
  ...
  "com.lihaoyi_mainargs_2.13-0.5.0" = fetchurl {
    ...
    postFetch = ''
      ...
      downloadedFile=$TMPDIR/mainargs_2.13-0.5.0.jar
      tryDownload "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.5.0/mainargs_2.13-0.5.0.jar"
      cp -v "$TMPDIR/mainargs_2.13-0.5.0.jar" "$out/"
...
# Project Source Hash:sha256-uPrinQyrtlT/zsG1QkdyP5y4McT3cdbkWae51WkBNEY=