...
in
{
  ...
  "com.lihaoyi_mainargs_2.13-0.7.0" = fetchMaven {
    ...
    urls = [
      "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.7.0/mainargs_2.13-0.7.0.jar"
      "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.7.0/mainargs_2.13-0.7.0.pom"
    ];
  ...
  "com.lihaoyi_mill-contrib-versionfile_2.13-0.12.8-1-46e216" = fetchMaven {
    name = "com.lihaoyi_mill-contrib-versionfile_2.13-0.12.8-1-46e216";
    urls = [
      "https://repo1.maven.org/maven2/com/lihaoyi/mill-contrib-versionfile_2.13/0.12.8-1-46e216/mill-contrib-versionfile_2.13-0.12.8-1-46e216.jar"
      "https://repo1.maven.org/maven2/com/lihaoyi/mill-contrib-versionfile_2.13/0.12.8-1-46e216/mill-contrib-versionfile_2.13-0.12.8-1-46e216.pom"
    ];
    hash = "sha256-UNRz3Q/1I36aS5wuKoEZaqXeIy42vd9J74f0yLG+jcg=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/mill-contrib-versionfile_2.13/0.12.8-1-46e216";
  };
  ...
  "com.github.lolgab_mill-mima-worker-api_2.13-0.0.23" = fetchMaven {
    name = "com.github.lolgab_mill-mima-worker-api_2.13-0.0.23";
    urls = [
      "https://repo1.maven.org/maven2/com/github/lolgab/mill-mima-worker-api_2.13/0.0.23/mill-mima-worker-api_2.13-0.0.23.jar"
      "https://repo1.maven.org/maven2/com/github/lolgab/mill-mima-worker-api_2.13/0.0.23/mill-mima-worker-api_2.13-0.0.23.pom"
    ];
    hash = "sha256-JxP3wz4XpsAlNj0u5iP6aQvPJa6QbB9RvBgY+TppWZE=";
    installPath = "https/repo1.maven.org/maven2/com/github/lolgab/mill-mima-worker-api_2.13/0.0.23";
  };

  "com.github.lolgab_mill-mima_mill0.11_2.13-0.0.23" = fetchMaven {
    name = "com.github.lolgab_mill-mima_mill0.11_2.13-0.0.23";
    urls = [
      "https://repo1.maven.org/maven2/com/github/lolgab/mill-mima_mill0.11_2.13/0.0.23/mill-mima_mill0.11_2.13-0.0.23.jar"
      "https://repo1.maven.org/maven2/com/github/lolgab/mill-mima_mill0.11_2.13/0.0.23/mill-mima_mill0.11_2.13-0.0.23.pom"
    ];
    hash = "sha256-NROI7sYrbrmiQ3csj2Ht0YIUAbyZ5VYbL1h+Mge/wvo=";
    installPath = "https/repo1.maven.org/maven2/com/github/lolgab/mill-mima_mill0.11_2.13/0.0.23";
  };
...
# Project Source Hash:sha256-cQ0ybo4sxt5X3UOH5NT1f8SmXV+4zeaTo/0zUIr/Kzg=
