...
{
  "algebra_2.13-2.8.0-bundle" = {
    pname = "algebra_2.13-2.8.0-bundle";
    version = "2.8.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/org/typelevel/algebra_2.13/2.8.0/algebra_2.13-2.8.0.jar";
      sha256 = "sha256-Pq5TlUH6v9UNtRhLYIxjqu/SzHj3kBAvWJEXjq0/PJM=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/typelevel/algebra_2.13/2.8.0";
    pkgname = "algebra_2.13";
  };
  "algebra_2.13-2.8.0-pom" = {
    pname = "algebra_2.13-2.8.0-pom";
    version = "2.8.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/org/typelevel/algebra_2.13/2.8.0/algebra_2.13-2.8.0.pom";
      sha256 = "sha256-IkBrh8+5Rs1P1UBnX1DlaEyxZhl6PIjkwyB2pPtqo38=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/typelevel/algebra_2.13/2.8.0";
    pkgname = "algebra_2.13";
  };
  ...
  "mainargs_2.13-0.5.0-bundle" = {
    pname = "mainargs_2.13-0.5.0-bundle";
    version = "0.5.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.5.0/mainargs_2.13-0.5.0.jar";
      sha256 = "sha256-OZaoXRrKkI1XeeffZp3mdQnk90O5Kn5+23pAGt/gDW0=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.5.0";
    pkgname = "mainargs_2.13";
  };
  "mainargs_2.13-0.5.0-pom" = {
    pname = "mainargs_2.13-0.5.0-pom";
    version = "0.5.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.5.0/mainargs_2.13-0.5.0.pom";
      sha256 = "sha256-MHtnt7dNuP7TDCGojY5t52u0M//s7gcTA1aLXXOe3ek=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/com/lihaoyi/mainargs_2.13/0.5.0";
    pkgname = "mainargs_2.13";
  };
  ...
  "scala-collection-compat_2.13-2.8.1-bundle" = {
    pname = "scala-collection-compat_2.13-2.8.1-bundle";
    version = "2.8.1";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/org/scala-lang/modules/scala-collection-compat_2.13/2.8.1/scala-collection-compat_2.13-2.8.1.jar";
      sha256 = "sha256-m4zGAo2rWBP+dRlQOCSZ1lX+h3fixLBzaOqp0RFuBJw=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/scala-lang/modules/scala-collection-compat_2.13/2.8.1";
    pkgname = "scala-collection-compat_2.13";
  };
  "scala-collection-compat_2.13-2.8.1-pom" = {
    pname = "scala-collection-compat_2.13-2.8.1-pom";
    version = "2.8.1";
    src = fetchurl {
      ...
      sha256 = "sha256-MA0vea6KXIInT/kHAjVfDIJF1EI61U6HncsrA0H8xA0=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/scala-lang/modules/scala-collection-compat_2.13/2.8.1";
    pkgname = "scala-collection-compat_2.13";
  };
  ...
  "spire-macros_2.13-0.18.0-bundle" = {
    pname = "spire-macros_2.13-0.18.0-bundle";
    version = "0.18.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/org/typelevel/spire-macros_2.13/0.18.0/spire-macros_2.13-0.18.0.jar";
      sha256 = "sha256-C3T4YWMgflziOspp68UM6loBYt3bfZ9oKVUseAErNrM=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/typelevel/spire-macros_2.13/0.18.0";
    pkgname = "spire-macros_2.13";
  };
  "spire-macros_2.13-0.18.0-pom" = {
    pname = "spire-macros_2.13-0.18.0-pom";
    version = "0.18.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/org/typelevel/spire-macros_2.13/0.18.0/spire-macros_2.13-0.18.0.pom";
      sha256 = "sha256-VHjwohE1YrKz9e18ue0mQwgJyre+P6WRQJSPo1qK4wg=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/typelevel/spire-macros_2.13/0.18.0";
    pkgname = "spire-macros_2.13";
  };
  "spire-platform_2.13-0.18.0-bundle" = {
    pname = "spire-platform_2.13-0.18.0-bundle";
    version = "0.18.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/org/typelevel/spire-platform_2.13/0.18.0/spire-platform_2.13-0.18.0.jar";
      sha256 = "sha256-uy9f9dMYD8L0ffcRM1cMdArLn5s9kX8/oMdnJ/rIYkA=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/typelevel/spire-platform_2.13/0.18.0";
    pkgname = "spire-platform_2.13";
  };
  "spire-platform_2.13-0.18.0-pom" = {
    pname = "spire-platform_2.13-0.18.0-pom";
    version = "0.18.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/org/typelevel/spire-platform_2.13/0.18.0/spire-platform_2.13-0.18.0.pom";
      sha256 = "sha256-hE15RU8mINBM6D+ZltoYgaPSbkEQ08hBTB6Je7whwYE=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/typelevel/spire-platform_2.13/0.18.0";
    pkgname = "spire-platform_2.13";
  };
  "spire-util_2.13-0.18.0-bundle" = {
    pname = "spire-util_2.13-0.18.0-bundle";
    version = "0.18.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/org/typelevel/spire-util_2.13/0.18.0/spire-util_2.13-0.18.0.jar";
      sha256 = "sha256-Ydmq5oLXhUWX4jsBvv6j20KvELxdsDPdsGYq++7h7PA=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/typelevel/spire-util_2.13/0.18.0";
    pkgname = "spire-util_2.13";
  };
  "spire-util_2.13-0.18.0-pom" = {
    pname = "spire-util_2.13-0.18.0-pom";
    version = "0.18.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/org/typelevel/spire-util_2.13/0.18.0/spire-util_2.13-0.18.0.pom";
      sha256 = "sha256-1sNL4zjLWdaVy8nPUNEae629/+T5KNzNztG2A6QlNgc=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/typelevel/spire-util_2.13/0.18.0";
    pkgname = "spire-util_2.13";
  };
  "spire_2.13-0.18.0-bundle" = {
    pname = "spire_2.13-0.18.0-bundle";
    version = "0.18.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/org/typelevel/spire_2.13/0.18.0/spire_2.13-0.18.0.jar";
      sha256 = "sha256-KyPEj47xP95yDcDyds82q/QqPwaVgtYs8ghyDDJ6ioY=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/typelevel/spire_2.13/0.18.0";
    pkgname = "spire_2.13";
  };
  "spire_2.13-0.18.0-pom" = {
    pname = "spire_2.13-0.18.0-pom";
    version = "0.18.0";
    src = fetchurl {
      url = "https://repo1.maven.org/maven2/org/typelevel/spire_2.13/0.18.0/spire_2.13-0.18.0.pom";
      sha256 = "sha256-Uzth59hl0bUwmfAPO1NK4sm1fB+7V+0cb4bq+x6vfpo=";
    };
    install_path = "v1/https/repo1.maven.org/maven2/org/typelevel/spire_2.13/0.18.0";
    pkgname = "spire_2.13";
  };
