...
package org.chipsalliance.dwbb.interface.DW01_sub
...
case class Parameter(width: Int = 18) extends SerializableModuleParameter {
...
class Interface(parameter: Parameter) extends Bundle {
  ...
  val DIFF: UInt = Output(UInt(parameter.width.W))
