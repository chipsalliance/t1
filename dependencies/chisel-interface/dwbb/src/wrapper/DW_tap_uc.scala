...
package org.chipsalliance.dwbb.wrapper.DW_tap_uc

import chisel3.experimental.IntParam
import org.chipsalliance.dwbb.interface.DW_tap_uc._
import org.chipsalliance.dwbb.wrapper.WrapperModule

import scala.collection.immutable.SeqMap

class DW_tap_uc(parameter: Parameter)
    extends WrapperModule[Interface, Parameter](
      ...
      p =>
        SeqMap(
          ...
          "idcode_opcode" -> IntParam(p.idcodeOpcode),
