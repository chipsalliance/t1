...
package org.chipsalliance.dwbb.wrapper.DW_fifoctl_s2_sf

import chisel3.experimental.IntParam
import org.chipsalliance.dwbb.interface.DW_fifoctl_s2_sf._
import org.chipsalliance.dwbb.wrapper.WrapperModule

import scala.collection.immutable.SeqMap

class DW_fifoctl_s2_sf(parameter: Parameter)
